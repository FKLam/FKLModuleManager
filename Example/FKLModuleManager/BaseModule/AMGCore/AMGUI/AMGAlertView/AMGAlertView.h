...
UIKIT_EXTERN NSString *const AMGAlertViewWillShowNotification;
UIKIT_EXTERN NSString *const AMGAlertViewDidShowNotification;
UIKIT_EXTERN NSString *const AMGAlertViewWillDismissNotification;
UIKIT_EXTERN NSString *const AMGAlertViewDidDismissNotification;

typedef void(^clickHandle)(void);

typedef void(^clickHandleWithIndex)(NSInteger index);

typedef NS_ENUM(NSInteger, AMGAlertViewButtonType) {
    AMGAlertViewButtonTypeDefault = 0,
    AMGAlertViewButtonTypeCancel,
    AMGAlertViewButtonTypeWarn,
    AMGAlertViewButtonTypeNone,
    AMGAlertViewButtonTypeHeight
};

@interface AMGAlertView : UIView
